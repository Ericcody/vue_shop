# Generated by Django 2.0.1 on 2018-10-08 23:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods_front_image_url', models.CharField(default='', max_length=300, verbose_name='封面图商品链接')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('parent_category', models.ForeignKey(blank=True, help_text='父目录', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='sub_cat', to='goods.GoodsCategory', verbose_name='父类级别')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default='', help_text='商标名', max_length=30, verbose_name='商标名')),
                ('desc', models.TextField(default='', help_text='商标描述', max_length=200, verbose_name='商标描述')),
